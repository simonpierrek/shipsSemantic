...
#'
#' Returns the two consecutive observations of a ship with the longest sailed distance
#'
...
#' @examples
#' # The two consecutive observations which describe the longest sailed distance for the ship 'MERI'
#' get_longest_dist_obs(data = ships, ship_name = 'MERI')
